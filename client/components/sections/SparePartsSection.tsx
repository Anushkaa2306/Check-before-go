...
export default function SparePartsSection() {
  ...
  return (
    <section id="spare-parts-section" className="py-24 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          {/* Section Icon */}
          <div className={`w-20 h-20 mx-auto mb-6 bg-primary/10 rounded-full flex items-center justify-center transition-all duration-700 ease-out delay-200 hover:scale-110 hover:bg-primary/20 ${
          ...
          {/* Section Title */}
          <h2
            className={`text-3xl lg:text-5xl font-bold mb-6 transition-all duration-700 ease-out delay-400 ${
          ...
          {/* Section Description */}
          <p
            className={`text-xl mb-8 max-w-2xl mx-auto transition-all duration-700 ease-out delay-600 ${
          ...
          <Card className={`max-w-2xl mx-auto bg-white transition-all duration-700 ease-out delay-800 hover:shadow-xl hover:scale-105 transform ${
            ...
            <CardHeader>
              <CardTitle className="flex items-center justify-center space-x-2">
                ...
                <span>Spare Parts Request Form</span>
              </CardTitle>
              <CardDescription>
            ...
            {/* Card Content - Required Information */}
            <CardContent>
              <div className="space-y-4 text-left">
                <h4 className="font-semibold text-center mb-4">Required Information:</h4>
                <div className="grid grid-cols-2 gap-4 text-sm text-muted-foreground">
                  {requiredInformation.map((info, index) => (
                    <div
                      key={index}
                      className={`flex items-center transition-all duration-500 ease-out hover:text-primary ${
            ...
            <CardFooter>
              ...
              >
                <Wrench className="mr-2 h-5 w-5 transition-transform duration-300 hover:rotate-12" />
                Request Spare Parts
              </Button>
            </CardFooter>
